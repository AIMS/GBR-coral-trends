...
manta.heat = CoralTrends_calc3ZoneLocations(manta.heat$Latitude)
...
ggsave('figures/TemporalHeatMap_3Zones.png', g,width=13, height=15, dpi=300)
ggsave('figures/TemporalHeatMap_3Zones.pdf', g,width=13, height=15, dpi=300)
