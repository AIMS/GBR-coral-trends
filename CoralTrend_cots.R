...
system("java -jar scripts/dbExport.jar data/primary/cots.sql data/primary/cots.csv reef reefmon")
...
cots.sum.all$Location <- factor(cots.sum.all$Zone, levels=c('All',"Northern","Central","Southern"),
