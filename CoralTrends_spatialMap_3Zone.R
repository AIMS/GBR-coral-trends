...
ggsave('figures/MapOfSites.png', grid.arrange(gm1,gm2,nrow=1),width=10, height=5, dpi=300)
ggsave('figures/MapOfSites.pdf', grid.arrange(gm1,gm2,nrow=1),width=10, height=5, dpi=300)
